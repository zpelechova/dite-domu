...
try:
    ...
    for i in range(1, 20):
        ...
        ##overit zda funguje get date, format spravny? melo by davat '2017-12-26'
        # created_on =date.today()
        
        #nevim jaky format datetime.datetime.now(),#str(date.today()) - da '2017-12-26'
